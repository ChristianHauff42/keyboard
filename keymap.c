...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [DVORAK] = LAYOUT(
        ...
        KC_LCTL, XXXXXXX, KC_LGUI, KC_LALT, KC_SPC,           DF(QWERTY),      DF(QWERTY),         KC_BSPC, KC_RALT, KC_RGUI, XXXXXXX, XXXXXXX,
    ...
    [QWERTY] = LAYOUT(
        KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    XXXXXXX,           XXXXXXX, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_PGUP,
        ...
        KC_LCTL, XXXXXXX, KC_LGUI, KC_LALT, KC_SPC,           DF(DVORAK),     DF(DVORAK),          KC_BSPC, KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT,
